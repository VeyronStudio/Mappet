...
import toraylife.mappetextras.modules.veyron.VeyronEventHandler;

public class CommonProxy {
    public static EventHandler eventHandler;
    public static EventTriggerHandler eventTriggerHandler;
    public static VeyronEventHandler veyronEventHandler;
    public CommonProxy() {
    }
    public void preInit(FMLPreInitializationEvent event) {
        ...
        MinecraftForge.EVENT_BUS.register(veyronEventHandler = new VeyronEventHandler());
        Dispatcher.register();
