...
import toraylife.mappetextras.modules.veyron.scripts.code.ScriptVeyron;
import toraylife.mappetextras.modules.veyron.scripts.code.ScriptVeyronHUD;
...
public class ScriptPlayer extends ScriptEntity<EntityPlayerMP> implements IScriptPlayer
{
    ...
    private IScriptVeyron horror;
    private IScriptVeyronHUD hud;
    ...
    @Override
    public IScriptVeyron getHorror()
    {
        if (this.horror == null)
        {
            this.horror = new ScriptVeyron(this.entity);
        }
    ...
    @Override
    public IScriptVeyronHUD getHud()
    {
        if (this.hud == null)
        {
            this.hud = new ScriptVeyronHUD(this.entity);
        }
