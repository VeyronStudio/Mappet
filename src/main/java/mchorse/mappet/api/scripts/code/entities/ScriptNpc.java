...
import toraylife.mappetextras.modules.veyron.scripts.code.ScriptVeyronStalker;
...
{
    private IScriptVeyronStalker stalker;
    ...
    @Override
    public IScriptVeyronStalker getStalker()
    {
        if (this.stalker == null)
        {
            this.stalker = new ScriptVeyronStalker(this.entity);
        }
