...
public interface IScriptPlayer extends IScriptEntity
{
    ...
    /**
     * Get horror and adventure API: fear, tension, noise, jumpscares, locked
     * actions, zones and music.
     */
    public IScriptVeyron getHorror();

    /**
     * Get Veyron HUD helper with layer and element IDs instead of Mappet HUD
     * morph indexes.
     */
